...
uint256 hashGenesisBlock("0xea09f08d083b7edc86c5e4bec95f122a35bd089b9baf872174cb017ec7463e1a");
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight >= 0 && nHeight <= 1000)
    {
        ...
        seed = hex2long(cseed);
        rand0 = generateMTRandom(seed, 100000);
        nSubsidy = (1 + rand0) * COIN;
    }
    else if(nHeight >= 1001 && nHeight <= 5000)
    {
        cseed_str = prevHash.ToString().substr(7,7);
        cseed = cseed_str.c_str();
        seed = hex2long(cseed);
        rand1 = generateMTRandom(seed, 10000);
    ...
    else if(nHeight >= 5001 && nHeight <= 10000)
    {
        ...
        cseed = cseed_str.c_str();
        seed = hex2long(cseed);
        rand2 = generateMTRandom(seed, 1000);
    ...
    else if(nHeight >= 10001 && nHeight <= 20000)
    {
        ...
        cseed = cseed_str.c_str();
        seed = hex2long(cseed);
        rand3 = generateMTRandom(seed, 100);
    ...
    else if(nHeight > 20001)
    {
        ...
        cseed = cseed_str.c_str();
        seed = hex2long(cseed);
        rand4 = generateMTRandom(seed, 10);
...
static const int64 nTargetTimespan = 60 * 60; // Kazcoin: every 4 hours
static const int64 nTargetSpacing = 60; // Kazcoin: 1 minutes
...
{
    // Kazcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xea09f08d083b7edc86c5e4bec95f122a35bd089b9baf872174cb017ec7463e1a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "04.06.1987";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	txNew.vout[0].scriptPubKey = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        ...
        assert(block.hashMerkleRoot == uint256("0x76b34f2725c9c54cd4962d2b38eff36f18e78a4bc3312693f73dd02316720ab2"));
        block.print();
